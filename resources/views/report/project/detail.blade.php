  ...
  <div class="col-md-12">
    <div class="widget">
        <header class="widget-header">
            <h4 class="widget-title">Last Update Project</h4>
        </header>
                                ...
                                <form class="form-horizontal">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6 text-right">
                                             @if(\DB::table('iapsys.project_progress')->where('project_id', '=', $model->inventory_item_id)->whereNotNull('validated_date')->count() > 0)
                                                <a href="{{ url($url.'/show-history-project/'.$model->inventory_item_id.'/'.ProjectController::TECHNICAL) }}" class="btn btn-sm btn-success">Show History Technical</a>
                                            @endif
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <?php $milestoneProgress = $milestone->getLastValidatedMilestoneProgress(); ?>
                                                        ...
                                                        <div class="panel-body">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-12 text-right">
                                                                    <a href="{{ url($url.'/show-history-milestone/'.$milestoneProgress->milestone_id.'/'.ProjectController::TECHNICAL) }}" class="btn btn-sm btn-success">Show History</a>
                                                                </div>
                                                                @endif
                                                            </div>
                                                            <div class="row">
                                                                <div class="col-md-12">
                                                                    ...
                                                                    <?php $taskProgress = $task->getLastValidatedTaskProgress(); ?>
                                                                            ...
                                                                            <div id="{{ 'task-'.$task->task_id }}" class="panel-collapse collapse" role="tabpanel" aria-labelledby="heading-2">
                                                                                <div class="panel-body">
                                                                                    <div class="row">
                                                                                        ...
                                                                                        <div class="col-md-12 text-right">
                                                                                            <a href="{{ url($url.'/show-history-task/'.$taskProgress->task_id.'/'.ProjectController::TECHNICAL) }}" class="btn btn-sm btn-success">Show History</a>
                                                                                        </div>
                                                                                        @endif
                                                                                    </div>
                                                                                </div>
                                ...
                                <form class="form-horizontal">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-12 text-right">
                                            @if(\DB::table('iapsys.project_progress')->where('project_id', '=', $model->inventory_item_id)->count() > 0)
                                            <a href="{{ url($url.'/show-history-project/'.$model->inventory_item_id.'/'.ProjectController::MARKETING) }}" class="btn btn-sm btn-success">Show History Masrketing</a>
                                            @endif
                                        </div>
                                    </div>
                                    <div class="row">
                                                    ...
                                                    <div id="{{ 'milestone-'.$milestone->milestone_id }}" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="heading-1">
                                                        <div class="panel-body">
                                                            <div class="row">
                                                                ...
                                                                @if(!empty($milestoneProgress))
                                                                <div class="col-md-12 text-right">
                                                                    <a href="{{ url($url.'/show-history-milestone/'.$milestoneProgress->milestone_id.'/'.ProjectController::MARKETING) }}" class="btn btn-sm btn-success">Show History</a>
                                                                </div>
                                                                @endif
                                                            </div>
                                                            <div class="row">
                                                                            ...
                                                                            <div id="{{ 'task-'.$task->task_id }}" class="panel-collapse collapse" role="tabpanel" aria-labelledby="heading-2">
                                                                                <div class="panel-body">
                                                                                    <div class="row">
                                                                                        ...
                                                                                        @if(!empty($taskProgress))
                                                                                        <div class="col-md-12 text-right">
                                                                                            <a href="{{ url($url.'/show-history-task/'.$taskProgress->task_id.'/'.ProjectController::MARKETING) }}" class="btn btn-sm btn-success">Show History</a>
                                                                                        </div>
                                                                                        @endif
                                                                                    </div>
                                                                                </div>
