  ...
  <div class="col-md-12">
    <div class="widget">
        <header class="widget-header">
            <h4 class="widget-title">Add Progress Project ({{ $section }})</h4>
        </header>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <input type="text" id="datetimepicker5" class="form-control" data-plugin="datetimepicker" data-options="{ format: 'DD-MM-YYYY' }" value="{{ !empty($startDate) ? $startDate->format('d-m-Y') : '' }}" name ="startDateMilestone-{{ $milestone->milestone_id }}">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="col-sm-4 control-label">End</label>
                                                    ...
                                                    <div class="col-sm-8">
                                                        <input type="text" id="datetimepicker5" class="form-control" data-plugin="datetimepicker" data-options="{ format: 'DD-MM-YYYY' }" value="{{ !empty($endDate) ? $endDate->format('d-m-Y') : '' }}" name ="endDateMilestone-{{ $milestone->milestone_id }}">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                    ...
                                                    <div class="panel panel-default">
                                                        <div class="panel-heading task-heading" role="tab" id="heading-2">
                                                            <a class="accordion-toggle" role="button" data-toggle="collapse" data-parent="#milestone-{{ $milestone->milestone_id }}" href="#{{ 'task-'.$task->task_id }}" aria-expanded="false" aria-controls="{{ 'task-'.$task->task_id }}">
                                                                <h4 class="panel-title">{{ $task->task_name }} (<span class="task-persentage">{{ !empty($taskProgress) ? $taskProgress->progress_percentage : 0}}</span>%)</h4>
                                                                <i class="fa acc-switch"></i>
                                                            </a>
                                                        </div>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <div class="col-sm-8">
                                                                                <input type="text" id="datetimepicker5" class="form-control" data-plugin="datetimepicker" data-options="{ format: 'DD-MM-YYYY' }" value="{{ !empty($startDate) ? $startDate->format('d-m-Y') : '' }}" name ="startDateTask-{{ $task->task_id }}">
                                                                            </div>
                                                                        </div>
                                                                        <div class="form-group">
                                                                            <label class="col-sm-4 control-label">End</label>
                                                                            ...
                                                                            <div class="col-sm-8">
                                                                                <input type="text" id="datetimepicker5" class="form-control" data-plugin="datetimepicker" data-options="{ format: 'DD-MM-YYYY' }" value="{{ !empty($endDate) ? $endDate->format('d-m-Y') : '' }}" name ="endDateTask-{{ $task->task_id }}">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-6">
