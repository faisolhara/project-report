  ...
  <div class="col-md-12">
    <div class="widget">
        <header class="widget-header">
            <h4 class="widget-title">Validate Progress Project</h4>
        </header>
            ...
            <form class="form-horizontal" id="form-update-progress" method="post" action="{{ url($url.'/save') }}">
                ...
                <div class="row">
                    <div class="col-sm-12 text-right">
                        ...
                        <a id="btn-save-progress" class="btn btn-sm btn-primary">Validate</a>
                    </div>
                </div>
                  ...
                  <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="form-group">
                                <label class="col-sm-12 control-label">Are you sure all the progress content is valid ?</label>
                            </div>
                        </div>
